package String.class_programs;
    ...
    public static void verifyPalindrome(String text) {
        String resIterative = isPalindromeIterative(text) ? "Palindrome" : "Not Palindrome";
        String resRecursive = isPalindromeRecursive(text) ? "Palindrome" : "Not Palindrome";
        String resReversal = isPalindromeArrayReversal(text) ? "Palindrome" : "Not Palindrome";
